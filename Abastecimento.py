...
def processar_relatorio(ano, mes):
    ...
    # Forçamos a criação das colunas caso não tenham aparecido na Pivot Table naquele mês específico
...
if __name__ == "__main__":
    # Subtrai 5 dias para garantir o fechamento do mês anterior no início do mês novo
